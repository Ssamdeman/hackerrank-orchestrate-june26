...
def main():
    ...
    report_lines.append("Stated pricing for **Claude 3.5 Sonnet** ($3.00/M input, $15.00/M output) vs. **Claude 3 Opus** ($15.00/M input, $75.00/M output):")
    report_lines.append("* **Claude 3.5 Sonnet Cost:**")
    ...
    report_lines.append("* **Claude 3 Opus Cost:**")
